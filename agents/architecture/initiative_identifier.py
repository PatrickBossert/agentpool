...
def create_initiative_identifier_task(
    ...
    return Task(
        description=(
            ...
            "3. Use SQLiteStateTool with operation='read', key='strategic_requirements', "
            "agent_name='initiative_identifier' to retrieve the strategic requirements "
            "each initiative must address.\n"
