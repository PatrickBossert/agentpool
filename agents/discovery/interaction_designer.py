...
def create_interaction_designer_task(
    ...
    return Task(
        description=(
            ...
            "── OUTPUT ───────────────────────────────────────────────────────────────────────\n"
            "15. Output ALL INTERVIEW SCRIPTS (L0, L1, L2, L3, C, A, F, and S) as a single JSON object keyed "
            ...
            "and for every role node (C, A, F, S). Below that, select: an L2 stage warrants "
