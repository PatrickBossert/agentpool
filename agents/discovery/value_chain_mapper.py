    ...
    return Task(
        description=(
            ...
            "5. Build the value chain as a single structured model - not a diagram. The model is a "
                ...
                "     TWO RULES THE HUMAN EDITOR ENFORCES ON SAVE. A model breaking either one loads "
                "into the editor's grid and then has every save refused, so get both right here:\n"
