    ...
    return Task(
        description=(
            ...
            "5. Build the value chain as a single structured model - not a diagram. The model is a "
                ...
                "  h) `entity` - the L0 entity: this organisation itself, as a node.\n"
                "     {\"entity\": {\"id\": \"0\", \"label\": \"<the organisation's own name>\", "
                "\"description\": \"<what this organisation is and what it is responsible for>\"}}\n"
                "     Id \"0\" is reserved for it, is never renumbered, and no value chain may "
                ...
                "rather than one chain - a regulator regulates this organisation, and a customer "
                "of it may sit in another company entirely. A model with no entity is REFUSED.\n"
            ...
            "structured JSON tree. The tree has a single root: the L0 entity, id \"0\", level "
            "\"L0\", with the value chains as its children. The registry is derived from the "
            "tree, so an entity absent from the tree is absent from the registry and nothing "
            "can anchor to it.\n"
            "   ROLE NODES. The root carries two organisation-level role nodes as direct "
            "children: id \"0.A\" level \"L0\" for Audit, and id \"0.S\" level \"L0\" for "
            "Corporate Services frontline. Each L1 entity carries the role nodes it warrants: "
            "id \"<L1>.C\" level \"L1\" for that entity's customer, and \"<L1>.F\" level "
            "\"L1\" for its frontline - so \"1.C\", \"1.F\", \"2.C\", \"2.F\". Role nodes are "
            "ordinary activities: Jordan assigns stakeholders to them, Maya writes interview "
            "scripts for them, and Casey anchors themes to them. They exist to give an "
            "outside-in and bottom-up view - C is what the organisation looks like from "
            "outside, F what it feels like from underneath. Audit and Corporate Services sit "
            "at L0 because they are organisation-level activities; customer and frontline sit "
            "at L1 because a Fleet customer and a Property customer need different interviews, "
            "as do a Fleet frontline worker and a Property one. Whether a given L1 warrants C "
            "or F is your judgement for this client - Support Services may warrant neither, "
            "since 0.S already covers corporate services frontline. Do NOT put role nuance on "
            "the node: that belongs on the stakeholder record, which is what lets one F "
            "programme serve both 1.F and 2.F while the answers still differ.\n"
            "   EVERY L1, L2 and L3 node MUST include an 'id' field — reuse "
