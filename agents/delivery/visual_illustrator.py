...
def create_visual_illustrator_task(
    ...
    return Task(
        description=(
            ...
            "4. Use SQLiteStateTool with operation='read', key='architecture_register', "
            "agent_name='visual_illustrator' to retrieve the architecture register "
            "(data, technology and organisation layers).\n"
        ...
        expected_output=(
            "The illustration_briefs output, written once via SQLiteStateTool, containing "
            "one illustration "
