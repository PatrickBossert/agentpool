        ...
        <div className="flex items-center gap-5">
          {lDate && cDate && (
            <span className="flex items-center gap-1.5">
              <span className="w-3 h-3 rounded bg-teal-500/30 border border-teal-400 inline-block" />
              {iwWorkingDays != null
          ...
          {(nonWorkingRanges.filter(r => r.end_date >= startDate && r.start_date <= endDate).length > 0 || visibleHolidays.length > 0) && (() => {
            ...
            return (
              <span className="flex items-center gap-1.5">
                <span className="w-3 h-3 rounded-sm bg-orange-400/30 border border-orange-400 inline-block" />
