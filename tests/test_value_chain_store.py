...
def _granted_authority():
    """This module is about versioning and attribution on save, not about who may save. The
    client fixture's sysadmin token names no real user, so caller_may_approve correctly
    answers False for it and the PUT would 403 before any of that ran.
